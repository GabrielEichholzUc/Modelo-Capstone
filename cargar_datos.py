...
def cargar_parametros_excel(archivo_excel="Parametros_Finales.xlsx"): 
    ...
    # Filas 2-7 son los afluentes (ELTORO, ABANICO, ANTUCO, TUCAPEL, CANECOL, LAJA1)
    ...
    print(f"  Afluentes: {min([a for a,w in parametros['QA'].keys()])} - {max([a for a,w in parametros['QA'].keys()])}")
